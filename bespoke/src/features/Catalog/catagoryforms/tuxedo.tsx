...
import Tuxedodesigns from './Tuxedoforms/tuxedodesigns';
import Tuxedostyle from './Tuxedoforms/Tuxedostyle';
import BodyTypeSelect from './blazersform/Bodytypeform';
import Tuxedofabric from './Tuxedoforms/Tuxedofabric';
import FullsuitMeasurements from './fullsuit/fullsuitmeasures';
import { Link } from 'react-router-dom';

const steps = ['Designs', 'Style', 'Body Type', 'Fabric', 'Measurements'];
