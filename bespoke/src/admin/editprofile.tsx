import { Typography, Box, TextField, Button, Grid, MenuItem, IconButton } from "@mui/material";
...
const Customerprofile = () => {
    ...
    return (
        <div>
            ...
            <Typography variant='h6' sx={{ marginY: "20px" }}> { } Profile </Typography>
            <Box
                sx={{
                    display: "flex",
            ...
            >
                ...
                >
                    <Typography variant="h6" sx={{ marginY: "12px" }}> Update Profile </Typography>
